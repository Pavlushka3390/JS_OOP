...
function main() {
    let goods = [
        new Good(1, "джинсы", "кожаные", [52, 54, 56, 58], 3600),
        new Good(2, "брюки", "полосатые", [54, 56, 58], 4000),
        new Good(3, "шорты", "укороченные", [52, 54, 58], 2500),
        new Good(4, "спортивные штаны", "адидас", [50, 52, 54], 3000),
        new Good(5, "колготки", "черные", [52, 54, 56], 500),
    ]
    ...
    let basketGoods = [
        new BasketGood(1, "джинсы", "кожаные", [52, 54, 56, 58], 3600, 20),
        new BasketGood(2, "брюки", "полосатые", [54, 56, 58], 4000, 0),
        new BasketGood(3, "шорты", "укороченные", [52, 54, 58], 2500, 6),
        new BasketGood(4, "спортивные штаны", "адидас", [50, 52, 54], 3000, 1),
        new BasketGood(5, "колготки", "черные", [52, 54, 56], 500, 0),
    ]
